...
def _deliver_result(
    ...
    for target in targets:
        ...
        if platform == Platform.YUANBAO and wrap_response:
        ...
        if not delivered:
            ...
            if not target_delivery_content.strip() and not media_files:
                msg = (
                ...
                try:
                    ...
                    try:
                        ...
                        future = pool.submit(
                            ...
                            asyncio.run,
                            _send_to_platform(platform, pconfig, chat_id, target_delivery_content, thread_id=thread_id, media_files=media_files),
                        )
